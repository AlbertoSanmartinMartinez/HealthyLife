...
urlpatterns = [
    ...
    # Blog URLS's
    url(r'^blog/$', blog_views.list_posts, name='list_post'),
    # hacer generica
    #url(r'^blog/subscripcion/$', blog_views.subscribe, name='subscribe'),

    url(r'^blog/(?P<post_slug>\w+)/$', blog_views.detail_post, name='detail_post'),
    # url(r'^blog/(?P<post_slug>\w+)/(?P<comment_parent_id>\w+)/comentado/$', views.comment, name='comment'),
    url(r'^blog/categorias/(?P<category>\w+)/$', blog_views.category_posts, name='category_posts'),
    url(r'^blog/autores/(?P<username>\w+)/$', blog_views.author_posts, name='author_posts'),
